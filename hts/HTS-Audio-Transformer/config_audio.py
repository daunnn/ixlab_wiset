...
# exp_name = "/wiset/hts/HTS-Audio-Transformer/cfg/HTSAT_AudioSet_Saved_6/" # the saved ckpt prefix name of the model 
exp_name = "/wiset/hts/HTS-Audio-Transformer/cfg/HTSAT_ESC_exp=1_fold=0_acc=0.970/"

workspace = "/wiset/hts/HTS-Audio-Transformer" # the folder of your code
dataset_path = "/wiset/hts/HTS-Audio-Transformer/person_dataset_3class/" # the dataset path
eval_dataset_path = "/wiset/hts/HTS-Audio-Transformer/person_dataset_3class/"
...
resume_checkpoint = "/wiset/hts/HTS-Audio-Transformer/cfg/HTSAT_AudioSet_Saved_6.ckpt"
#"/wiset/hts/HTS-Audio-Transformer/cfg/HTSAT_AudioSet_Saved_6.ckpt" 
#"/wiset/hts/HTS-Audio-Transformer/cfg/HTSAT_AudioSet_Saved_6.ckpt"
...
batch_size = 1  # batch size per GPU x GPU number , default is 32 x 4 = 128  #여기 중요 !!! 잘 맞춰서 넣어줘야함 !! 
'''test할 때 batch_size =1로 설정'''
...
fl_dataset = "/wiset/hts/HTS-Audio-Transformer/person_dataset_3class/esc-50-data.npy"
fl_class_num = [
    "0","1","2"
]
